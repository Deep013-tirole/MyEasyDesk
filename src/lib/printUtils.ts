...
export function printElement(element: HTMLElement | null, documentTitle: string = 'EasyDesk Document Record'): void {
  ...
  // Use an isolated hidden iframe with copied stylesheets so ONLY the target element is printed
  // without any dashboard, navigation, table, sidebar, or interactive buttons leaking into print.
  try {
          ...
          <head>
            ...
            <style>
              ...
              *, *::before, *::after {
              ...
              .no-print, .print\\:hidden, nav, aside, header, footer, button, input, select, textarea {
  ...
  // Fallback direct print execution
  printCurrentWindow(documentTitle);
}
